...
- **Freight costs** for each vendor (representing delivery costs)  
- **Actual product prices** from vendors  

This consolidated dataset enables a comprehensive vendor performance analysis, helping improve decision-making for promotions, pricing, and inventory management.

<img width="1317" height="743" alt="image" src="https://github.com/user-attachments/assets/13f6527c-beb0-49ca-b2aa-93864daed27f" />
